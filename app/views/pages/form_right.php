<div class=col-md-4><!--div right-->
    ...
    <div>
        ...
        <img src="<?=base_url('assets/img/organizares/220x0_logo_mir_jpg.jpg" alt="220x0_logo_mir_jpg.jpg')?> "/>
        <img src="<?=base_url('assets/img/organizares/220x0_een_logo_pravi.png" alt="220x0_een_logo_pravi.png')?> "/>
        <img src="<?=base_url('assets/img/organizares/220x0_YES_logo_transparent.png" alt="220x0_YES_logo_transparent.png')?> "/>

        <h3 class="svgbg">CO-ORGANIZERS</h3>
        <img src="<?=base_url('assets/img/co-organizares/220x0_ARC_Consulting.png" alt="220x0_ARC_Consulting.png')?> "/>
        <img src="<?=base_url('assets/img/co-organizares/220x0_univerzitet_u_novom_sadu.png" alt="220x0_univerzitet_u_novom_sadu.png')?> "/>
        <img src="<?=base_url('assets/img/co-organizares/220x0_pkcg_logo1.png" alt="220x0_pkcg_logo1.png')?> "/>
        <img src="<?=base_url('assets/img/co-organizares/220x0_nlchamber.png" alt="220x0_nlchamber.png')?> "/>
        <img src="<?=base_url('assets/img/co-organizares/220x0_nis.gif" alt="220x0_nis.gif')?> "/>
        <img src="<?=base_url('assets/img/co-organizares/220x0_TARR_pelna_nazwa_ang_kopia.png" alt="220x0_TARR_pelna_nazwa_ang_kopia.png')?> "/>
        <img src="<?=base_url('assets/img/co-organizares/220x0_IJS_logo.jpg" alt="220x0_IJS_logo.jpg')?> "/>
        <img src="<?=base_url('assets/img/co-organizares/220x0_logo_sr_Cyrl_BA.PNG" alt="220x0_logo_sr_Cyrl_BA.PNG')?> "/>
        <img src="<?=base_url('assets/img/co-organizares/220x0_ARIES_logo.png" alt="220x0_ARIES_logo.png')?> "/>
        <img src="<?=base_url('assets/img/co-organizares/220x0_ZRS_UP20_barvni_manj_i_75.jpg" alt="220x0_ZRS_UP20_barvni_manj_i_75.jpg')?> "/>
        <img src="<?=base_url('assets/img/co-organizares/220x0_fing_logo.png" alt="220x0_fing_logo.png')?> "/>
        <img src="<?=base_url('assets/img/co-organizares/220x0_cda_2_Test_CDA.JPG" alt="220x0_cda_2_Test_CDA.JPG')?> "/>
        <img src="<?=base_url('assets/img/co-organizares/220x0_bsc_bar_logo.jpg" alt="220x0_bsc_bar_logo.jpg')?> "/>

        <h3 class="svgbg">SUPPORTERS</h3>
        <img src="<?=base_url('assets/img/supporters/220x0_ministry_of_economy.jpg" alt="220x0_ministry_of_economy.jpg')?> "/>
        <img src="<?=base_url('assets/img/supporters/220x0_CEI_logo.jpg" alt="220x0_CEI_logo.jpg')?> "/>
